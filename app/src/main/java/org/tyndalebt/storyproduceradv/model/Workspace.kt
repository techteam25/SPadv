...
//    const val URL_FOR_TEMPLATES_PLACE_HOLDER = "URL_FOR_TEMPLATES_PLACE_HOLDER"
    ...
    fun setupVideoCopyPath(context: Context, uri: Uri) {
        try {
            ...
            Log.e("setupVideoCopyPath", "Error setting up new vidoe copy path!", e)
        }
    }
    ...
    fun setupStoryBackupPath(context: Context, uri: Uri) {
        try {
            ...
            Log.e("setupStoryBackuupPath", "Error setting up new story backup path!", e)
        }
    }
    ...
    fun addWordLinksCSVFileToWorkspace(context: Context, csvFileName: String) {
        ...
        // Worklinks directory.
        // This routine is called anytime a ".csv" file cannot be found in the worklinks directory
        val assetManager = context.assets
